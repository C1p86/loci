...
function buildProgram() {
  ...
  program2.name("loci").description("Local CI \u2014 cross-platform command alias runner").version(LOCI_VERSION, "-V, --version", "output the current loci version").helpOption("-h, --help", "display help for command").showHelpAfterError().exitOverride();
  program2.action(() => {
    program2.outputHelp();
