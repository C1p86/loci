...
var require_error = __commonJS({
  "node_modules/commander/lib/error.js"(exports$1) {
...
var require_argument = __commonJS({
  "node_modules/commander/lib/argument.js"(exports$1) {
...
var require_help = __commonJS({
  "node_modules/commander/lib/help.js"(exports$1) {
...
var require_option = __commonJS({
  "node_modules/commander/lib/option.js"(exports$1) {
    var { InvalidArgumentError: InvalidArgumentError2 } = require_error();
    var Option2 = class {
      /**
...
var require_suggestSimilar = __commonJS({
  "node_modules/commander/lib/suggestSimilar.js"(exports$1) {
    var maxDistance = 3;
...
var require_commander = __commonJS({
  "node_modules/commander/index.js"(exports$1) {
...
var require_dist = __commonJS({
  "node_modules/yaml/dist/index.js"(exports$1) {
    ...
    exports$1.isAlias = identity3.isAlias;
    exports$1.isCollection = identity3.isCollection;
    exports$1.isDocument = identity3.isDocument;
    exports$1.isMap = identity3.isMap;
    exports$1.isNode = identity3.isNode;
    exports$1.isPair = identity3.isPair;
    exports$1.isScalar = identity3.isScalar;
    exports$1.isSeq = identity3.isSeq;
...
function flattenToStrings(obj, filePath, prefix = "") {
  const result = {};
  for (const [key, value] of Object.entries(obj)) {
    ...
    if (typeof value === "string") {
      ...
      const nested = flattenToStrings(value, filePath, fullKey);
...
function validateStringArray(aliasName, value, fieldName) {
  if (!Array.isArray(value)) {
...
function normalizePlatformBlock(aliasName, platformKey, block) {
...
function normalizeObject(aliasName, obj, _filePath) {
  ...
  const platformKeys = ["linux", "windows", "macos"];
  let platforms;
  for (const platform2 of platformKeys) {
    if (Object.hasOwn(obj, platform2)) {
      if (platforms === void 0) {
        platforms = {};
      }
      const platformCmd = normalizePlatformBlock(aliasName, platform2, obj[platform2]);
      platforms = { ...platforms, [platform2]: platformCmd };
    }
  }
  const rawCmd = obj.cmd;
  if (rawCmd === void 0 && platforms === void 0) {
...
function normalizeAlias(aliasName, raw, filePath) {
  ...
  if (typeof raw === "object" && raw !== null) {
    return normalizeObject(aliasName, raw);
  }
...
function selectPlatformCmd(def, aliasName) {
...
function redactSecrets(envVars, secretKeys) {
    ...
    case "single":
      ...
      if (def.platforms) {
        for (const [os, cmd] of Object.entries(def.platforms)) {
          if (cmd) lines.push(`  ${os}: ${cmd.join(" ")}`);
        }
      }
      break;
    case "sequential":
      lines.push("  steps:");
      def.steps.forEach((step, i2) => lines.push(`    ${i2 + 1}. ${step}`));
      break;
    case "parallel":
