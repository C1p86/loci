...
**Plans**: 6 plans
- [ ] 13-01-PLAN.md — Server extensions: /api/auth/me + /badge SVG + schema migration 0006 [BLOCKING] (backfills orgs.slug, tasks.slug, tasks.expose_badge)
...
| 13. Web Dashboard SPA | 0/6 | Not started | - |
