...
- [ ] 13-06-PLAN.md — CI web gates + Playwright Linux smoke + READMEs + STATE/ROADMAP/REQUIREMENTS traceability + 13-CLOSEOUT-SUMMARY + human-verify checkpoint
**UI hint**: yes
...
| 13. Web Dashboard SPA | 5/6 | In Progress|  |
